...
func (c *Compiler) makeBranchFunction(branchName string, body ast.BlockStmt) interfaces.Function {
	...
	branchFunc := ast.NewAutogeneratedFunctionDeclarationStatement(branchName, []ast.VariableDeclarationStmt{}, body, types.VoidType)

	source := ast.AcceptStmt[interfaces.IRCode](branchFunc, c)
